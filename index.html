            ...
            <div class="container-fluid" >
                        ...
                        <div class="collapse navbar-collapse" id="Navbar">
                            ...
                            <div class="navbar-nav ms-auto">
                                <a href="#" role="button" class="btn text-white" id="bookNowBtn" style="background-color: #29323d;">Book now</a>
                            </div>
                        </div>
            </div>
        </nav>
        ...
        <div class="container" id="masthead">
            <div class="row row-content">
                <div class="col-md-5">
                    ...
                    <a href="#" role="button" class="btn btn-primary" id="mastheadBtn">Get in Touch!</a>
                </div>
                <div class="col-md-7">
...
<!--.............................Skiils description Section..........................................-->
        <div class="container" id="skillsContainer">
            <div class="row row-content" id="mainSummaryContainer">
                <div class="col-md-4" id="summary1">
                ...
                <div class="col-md-4" id="summary2">
                    <div class="container" id="subContainer1">
                        <div class="row justify-content-center">
                            <div class="col">
                                <img class="summaryIcon" src="./images/shutter.png" alt="Shutter icon"> 
                ...
                <div class="col-md-4" id="summary3">
                    <div class="container" id="subContainer1">
                        <div class="row justify-content-center">
                            <div class="col">
                                <img class="summaryIcon" src="./images/shutter.png" alt="Shutter icon"> 
        ...
        <div class="container" id="gallery">
            ...
            <div class="row gx-3">
                <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                    <img src="./images/landscape1.jpg" class="w-100 shadow-1-strong rounded mb-2" style="height: 19.5%;" alt=""/>
                    <img src="./images/landscape10.jpg" class="w-100 shadow-1-strong rounded mb-2 h-70" alt="image of jurong lake gardens"/>
                </div>
                <div class="col-lg-4 col-md-12 mb-4 mb-sm-0 mb-lg-0">
                    <img src="./images/person1.jpg" class="w-100 shadow-1-strong rounded mb-2" style="height: 58%;"alt=""/>
                    <img src="./images/landscape9.jpg" class="w-100 shadow-1-strong rounded mb-2" style="height: 29.5%;" alt="image of marina bay sands"/>
                </div>
                <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                    <img src="./images/landscape8.jpg" class="w-100 shadow-1-strong rounded mb-2" style="height: 29.5%;" alt="image of the church of the good shepherd"/>
                    <img src="./images/landscape7.jpg" class="w-100 shadow-1-strong rounded mb-2" style="height: 58%;"alt=""/>
                </div>
            </div>
        </div>
<!--.........................................................................................-->
...
<!--.......................................Pricing Section..........................................-->
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane container fade show active" id="tab1"> 
                <div class="row justify-content-center">
                    <div class="package col-3 rounded text-center">
                        ...
                        <a href="#" role="button" class="getStarted btn text-white">Get Started</a>
                    </div>
                    <div class="package col-3 rounded text-center">
 ...
 <!--.............................Contact Section..........................................-->
                ...
                <div class="col-9 text-center">
                    <form action="mail.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email" id="emailID" placeholder="Your Email...">
                        </div>
                        <div class="form-group">
                            <label for="message">Message</label>
                            <input type="text" class="textarea form-control" name="message" id="message" placeholder="Enter Message...">
                        </div> 
                        <a href="#" role="button" class="btn text-white" id="formBtn" type="submit" value="Submit">Submit</a>
                    </form>
                </div>
            </div> 
        </div>
    ...
    <footer>
        <div class="container" >
            <div class="row justify-content-center">
                <div class="col-auto">
                    <h6>@ Copyright SHYAM SUNDAR, 2021. All Rights Reserved.</h4>
                </div>
            </div>
